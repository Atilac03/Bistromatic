...
Test(test_infin_add, 1_digit_addition_with_1_digit_result)
{
    cr_assert_str_eq(infin_add("0", "0"), "0");
    cr_assert_str_eq(infin_add("2", "0"), "2");
    cr_assert_str_eq(infin_add("0", "2"), "2");
    cr_assert_str_eq(infin_add("1", "3"), "4");
    cr_assert_str_eq(infin_add("3", "1"), "4");
    cr_assert_str_eq(infin_add("5", "4"), "9");
    cr_assert_str_eq(infin_add("3", "2"), "5");
}
